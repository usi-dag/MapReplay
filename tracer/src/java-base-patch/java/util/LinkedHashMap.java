    ...
    implements SequencedMap<K,V>
{
    ...
    static class Entry<K,V> extends HashMap.Node<K,V> {
        ...
        Entry(int hash, K key, V value, Node<K,V> next, long keyID) {
            super(hash, key, value, next, keyID);
        }
    }
    ...
    Node<K,V> newNode(int hash, K key, V value, Node<K,V> e) {
        LinkedHashMap.Entry<K,V> p =
            new LinkedHashMap.Entry<>(hash, key, value, e, nextKeyID++);
        linkNodeAtEnd(p);
        return p;
    }
    ...
    Node<K,V> replacementNode(Node<K,V> p, Node<K,V> next) {
        ...
        LinkedHashMap.Entry<K,V> t =
            new LinkedHashMap.Entry<>(q.hash, q.key, q.value, next, p.keyID);
        transferLinks(q, t);
        return t;
    }

    TreeNode<K,V> newTreeNode(int hash, K key, V value, Node<K,V> next) {
        TreeNode<K,V> p = new TreeNode<>(hash, key, value, next, nextKeyID++);
        linkNodeAtEnd(p);
        return p;
    }
    ...
    TreeNode<K,V> replacementTreeNode(Node<K,V> p, Node<K,V> next) {
        LinkedHashMap.Entry<K,V> q = (LinkedHashMap.Entry<K,V>)p;
        TreeNode<K,V> t = new TreeNode<>(q.hash, q.key, q.value, next, p.keyID);
        transferLinks(q, t);
        return t;
    }
